...
public class UserDao {
	...
	public int adminAdd(Connection con, String username,String  password,String  name,String  sex,String  tel)throws Exception {
		String sql = "INSERT INTO t_admin( userName, password, name, sex, tel) VALUES (?,?,?,?,?)";
		PreparedStatement pstmt = con.prepareStatement(sql);
